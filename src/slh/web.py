...
:root{
  /* Nerdy dark canvas */
  --bg:#0F0928;          /* deep Nerdy purple-navy */
  --card:#1a1238;        /* purple-lifted raised surface */
  --card2:#231a4a;       /* table headers / alt rows */
  --line:#2a2244;        /* purple-tinted divider */
  --ink:#FFFFFF;
  --mut:#9E97FF;         /* light purple text */
  --mut2:#6C6E87;

  /* Nerdy brand trio (from nerdy.com CSS) */
  --blue:#5D70FF;        /* readable Nerdy blue */
  --purple:#D684FF;      /* vibrant Nerdy purple */
  --pink:#FB43DA;        /* hot Nerdy magenta */
  --indigo:#6C64C9;      /* deeper purple-blue */
  --accent:var(--pink);  /* brand bar / primary accent */

  /* Semantic mapping over the trio */
  --good:var(--blue);
  --bad:var(--pink);
  --warn:var(--purple);
}
...
body{margin:0;background:var(--bg);color:var(--ink);min-height:100vh;
  ...
  background-image:radial-gradient(circle at 90% -10%,rgba(251,67,218,0.10) 0%,transparent 55%),
    radial-gradient(circle at 0% 100%,rgba(93,112,255,0.10) 0%,transparent 50%)}
...
h3{font-size:13px;margin:18px 0 10px;color:var(--accent);font-weight:600;
  text-transform:uppercase;letter-spacing:.08em}
.sub{color:var(--mut);margin:0 0 6px;font-size:15.5px}
.cap{color:var(--mut2);margin:0 0 16px;font-size:14px;max-width:780px;font-style:italic}
.brandbar{height:4px;width:96px;border-radius:4px;margin:18px 0 28px;
  background:linear-gradient(90deg,var(--blue),var(--purple),var(--pink));
  box-shadow:0 0 22px rgba(251,67,218,0.45)}

.summary{background:var(--card);border:1px solid var(--line);border-radius:14px;
  padding:24px 26px;margin:18px 0 32px;
  box-shadow:0 1px 0 rgba(0,0,0,0.2),0 8px 28px rgba(0,0,0,0.35)}
...
.stat:nth-child(3){border-left-color:var(--pink)}
.stat:nth-child(4){border-left-color:var(--indigo)}
...
.pill.good{background:rgba(93,112,255,.20);color:var(--blue)}
.pill.bad{background:rgba(251,67,218,.18);color:var(--pink)}
.pill.warn{background:rgba(214,132,255,.20);color:var(--purple)}
...
.cell-fail{color:var(--pink);font-weight:600;background:rgba(251,67,218,0.10)}
...
ul.fail li.bad{color:var(--pink);border-left:3px solid var(--pink)}
...
.foot{margin-top:46px;color:var(--mut2);font-size:13.5px;
  border-top:1px solid var(--line);padding-top:16px;font-style:italic}
a{color:var(--purple);text-decoration:none;border-bottom:1px solid rgba(214,132,255,0.4)}
a:hover{border-bottom-color:var(--purple);color:var(--pink)}

.tagline{color:var(--mut);font-weight:600;font-size:11.5px;
  text-transform:uppercase;letter-spacing:.14em}
.tagline .dot{color:var(--pink)}
"""
